...
export const CreateJobSchema = z.object({
  ...
  // New field for ExpectedTime
  ExpectedTime: z.string().regex(/^(\d+ (months?|years?|days?))$/, {
    message: 'Expected Time must be a valid number followed by months, years, or days.',
  }),
